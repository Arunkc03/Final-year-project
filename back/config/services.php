...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Khalti is a digital wallet and online payment gateway in Nepal.
    | Configure your Khalti secret key and public key here.
    |
    */
    'khalti' => [
        ...
        'return_url' => env('KHALTI_RETURN_URL', '/payment/verify'),
